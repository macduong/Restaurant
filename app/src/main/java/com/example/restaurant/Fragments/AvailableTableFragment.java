...
import com.example.restaurant.databinding.FragmentAvailableTableBinding;
 ...
 * Use the {@link AvailableTableFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AvailableTableFragment extends Fragment {
    FragmentAvailableTableBinding binding;
    private Data data;
     ...
     * @return A new instance of fragment AvailableTableFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AvailableTableFragment newInstance(String param1, String param2) {
        AvailableTableFragment fragment = new AvailableTableFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_available_table, container, false);
        data = new Data(getContext());

        tableList.addAll(data.searchAllAvailableTables());
