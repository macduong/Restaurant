...
import com.example.restaurant.databinding.FragmentUnavailableTableBinding;
 ...
 * Use the {@link UnavailableTableFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UnavailableTableFragment extends Fragment {
    private FragmentUnavailableTableBinding binding;
    private Data data;
    ...
    public UnavailableTableFragment() {
     ...
     * @return A new instance of fragment UnavailableTableFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UnavailableTableFragment newInstance(String param1, String param2) {
        UnavailableTableFragment fragment = new UnavailableTableFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_unavailable_table, container, false);
        data = new Data(getContext());

        tableList.addAll(data.searchAllUnavailableTables());
